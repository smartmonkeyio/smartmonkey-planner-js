...
describe(`Test Vehicles API`, () => {
  ...
  describe(`Vehicle CRUD`, () => {
    it(`should create a vehicle`, async () => {
      const vehicle = await highway.vehicle.createMany({ vehicles: [loader.vehicles.vehicle1], projectId: allProjectIds[0] });
    ...
    it(`Should be able to create many vehicles at a time`, async () => {
      const vehicles = await highway.vehicle.createMany({ vehicles: [{}, {}, {}], projectId: allProjectIds[0] });
    ...
    it(`Should be able to retrieve a list of vehicles`, async () => {
      const vehicle = await highway.vehicle.search({ projectId: allProjectIds[0] });
